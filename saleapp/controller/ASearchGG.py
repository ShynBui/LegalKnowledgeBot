...
def api_search_gg():
    ...
    # query = "Định nghĩa luật giao thông là gì ?"
    num_results = 3
    ...
    for i in docs:
        ...
        question = ViTokenizer.tokenize(query)
    ...
    print(my_result)
    tmp = my_result[my_result.scores >= 0.5]
    my_result = my_result[my_result.scores == my_result.scores.max()] if len(tmp) == 0 else tmp
