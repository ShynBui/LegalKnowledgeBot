...
const Home = () => {
    return (
        <>
            <div style={{ backgroundImage: `url("assets/banner.png")`, backgroundRepeat:'no-repeat', backgroundSize:'cover', width:'100%', height:'400px' }}>
            ...
            <div className="footer">
                <MDBFooter bgColor="light" className="text-center text-lg-start text-muted">
                    ...
                    <section className="" style={{ backgroundColor: '#232832', color: '#FFFFFF', padding: '20px' }}>
